...
class FuncTestCaseParserListener(ParseTreeListener):
    ...
    def enterIntervalYearLiteral(self, ctx:FuncTestCaseParser.IntervalYearLiteralContext):
        pass

    # Exit a parse tree produced by FuncTestCaseParser#intervalYearLiteral.
    def exitIntervalYearLiteral(self, ctx:FuncTestCaseParser.IntervalYearLiteralContext):
        pass


    # Enter a parse tree produced by FuncTestCaseParser#intervalDayLiteral.
    def enterIntervalDayLiteral(self, ctx:FuncTestCaseParser.IntervalDayLiteralContext):
        pass
    ...
    def enterPrecisionTimestamp(self, ctx:FuncTestCaseParser.PrecisionTimestampContext):
        pass
    ...
    def enterPrecisionTimestampTZ(self, ctx:FuncTestCaseParser.PrecisionTimestampTZContext):
        pass

    # Exit a parse tree produced by FuncTestCaseParser#precisionTimestampTZ.
    def exitPrecisionTimestampTZ(self, ctx:FuncTestCaseParser.PrecisionTimestampTZContext):
        pass
