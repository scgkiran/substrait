...
class FuncTestCaseParserVisitor(ParseTreeVisitor):
    ...
    def visitIntervalYearLiteral(self, ctx:FuncTestCaseParser.IntervalYearLiteralContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by FuncTestCaseParser#intervalDayLiteral.
    def visitIntervalDayLiteral(self, ctx:FuncTestCaseParser.IntervalDayLiteralContext):
        return self.visitChildren(ctx)
    ...
    def visitPrecisionTimestamp(self, ctx:FuncTestCaseParser.PrecisionTimestampContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by FuncTestCaseParser#precisionTimestampTZ.
    def visitPrecisionTimestampTZ(self, ctx:FuncTestCaseParser.PrecisionTimestampTZContext):
        return self.visitChildren(ctx)
